...
export default function ProductEcosystem() {
  return (
    <section className="relative py-20 bg-white border-t border-b border-[#E5E7EB]/50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 lg:px-6 w-full flex flex-col items-center">
